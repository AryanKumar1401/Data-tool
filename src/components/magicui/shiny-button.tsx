...
const ShinyButton = ({ text = "Unlock Your Data Power" }) => {
  return (
    <motion.button
      {...animationProps}
    ...
    >
      <span
        className="relative block h-full w-full text-sm uppercase tracking-wide text-[rgb(255,255,255,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
